...
class customHtaccessEdit implements item {
    ...
    public static function render($config, $component, $element, $data, &$jsInclude) {
        ...
        ob_start();
        include("templates/components/customHtaccessEdit.php");
        return ob_get_clean();
    }
    ...
    public static function getJs() {
        return "js/components/customHtaccessEdit.js";
    }
    ...
    public static function findData($application, $element) {
        include "customHtaccessEdit/findData.php";
    }

    public static function submitData($application, $element) {
        include "customHtaccessEdit/submitData.php";
    }
