...
class customContentFinder implements item {
    ...
    public static function render($config, $component, $element, $data, &$jsInclude) {
        ...
        ob_start();
        include("templates/components/customContentFinder.php");
        return ob_get_clean();
    }
    ...
    public static function getJs() {
        return "js/components/customContentFinder.js";
    }
    ...
    public static function findData($application, $element) {
        include "customContentFinder/findData.php";
    }
